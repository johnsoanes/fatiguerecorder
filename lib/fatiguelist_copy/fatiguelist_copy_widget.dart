...
class FatiguelistCopyWidget extends StatefulWidget {
  const FatiguelistCopyWidget({Key key}) : super(key: key);

  @override
  _FatiguelistCopyWidgetState createState() => _FatiguelistCopyWidgetState();
}
